...
class HubSpot_Ecommerce_OAuth_Client {
    ...
    /**
     * Get OAuth client ID from environment or wp-config.php
     */
    private function get_client_id() {
        ...
        // Fallback to default for development (replace in production)
        return 'b4cf1036-14c9-4e46-a976-be06e31f2a78';
    }

    /**
     * Get OAuth client secret from environment or wp-config.php
     */
    private function get_client_secret() {
        ...
        // Fallback to default for development (replace in production)
        return '8651ec90-6c28-41a4-8c36-82c9f5694936';
    }
