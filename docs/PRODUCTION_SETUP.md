...
These are included as fallbacks in the code for development but **should be overridden in production** via wp-config.php.
...
define('HUBSPOT_LICENSE_CONSUMER_KEY', 'ck_abc123def456...'); // From Step 2B
define('HUBSPOT_LICENSE_CONSUMER_SECRET', 'cs_xyz789ghi012...'); // From Step 2B
